// https://github.com/champloo11/ngEasyImageCrop/blob/master/easyImageCrop/imageCrop.js
angular.module('OpenData')
  .directive('imageCrop', [function($compile) {
    return {
      restrict: 'A',
      templateUrl: 'views/image-crop.html',
      scope: {
        aspectRatio: '=?',
        displayWidth: '=?',
        displayHeight: '=?',
